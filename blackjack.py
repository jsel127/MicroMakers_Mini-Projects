...
class Hand():
    ...
    def display(self, show_all_dealer_cards=False):
        print(f'''{"Dealer's" if self.dealer else "Your"} hand: ''') # ''' allows use of double and single quotes
...
class Game():
    def play(self):
        ...
        while game_number < games_to_play:
            ...
            self.check_winner(dealer_hand, player_hand, game_over=True)        
        print("\nThanks for playing!")
    ...
    def check_winner(self, dealer_hand, player_hand, game_over=False):
        if not game_over:
            ...
            difference = dealer_hand.get_value() - player_hand.get_value()
            if difference > 0:
                print("Dealer won :(")
            elif difference == 0:
                print("Tie")
